  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center gap-1.5">
        {pending ? "Đang tạo…" : "Tạo link hoàn tiền"}
...
export function CreateLinkForm() {
  ...
  return (
    <form ref={formRef} action={action} className="space-y-3">
      <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 transition-colors focus-within:border-[#b7e961]">
